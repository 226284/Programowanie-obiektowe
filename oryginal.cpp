...
void Wypisz_stat(Statystyka &stat)
{
  ...
  if(stat.Calkowita_liczba != stat.Bledna_skladnia){
...
int main()
{
  ...
  //Sprawdzenie czy ogólna składnia wyrażenia jest prawidłowa
	...
	{
	  cerr << " To nie powinno się wyświetlić :P " << endl;
	  assert(0);
	}
	...
	{
	  cout << "  Niepoprawny znak wyniku." << endl;
	}
      else
	{
	  cerr << "  To nie powinno się pojawić :(" <<endl;
	  assert(0);
	}    
    }
    }
